module.exports = {
	...
	main: function(bot, msg) {
		...
		if (msg.guild.id == '176186766946992128') {
			allowedRoles = ['Gaming', 'Wiring', 'Build', 'Programming', 'Marketing', 'Design', 'Awards', 'Strategy', 'Politics', 'Java', 'C++', 'LabVIEW', 'Python', 'Media', 'CS:GO', 'Civilization', 'CAH', 'League of Legends', 'Overwatch', 'Rocket League', 'Minecraft', 'ChezyChamps', 'Hackathon', 'Alumni', 'Solidworks', 'Inventor', 'Social'];
