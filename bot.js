...
bot.on("message", (msg) => {
    ...
    if (msg.channel.type === "text") {
      ...
      db.serialize(function() {
        db.run(`CREATE TABLE IF NOT EXISTS frc-logs-${day}-${month}-${year} (MSGINDEX INTEGER PRIMARY KEY, TIME DATETIME DEFAULT CURRENT_TIMESTAMP, CHANNEL_ID VARCHAR(32) NOT NULL, AUTHOR_ID VARCHAR(32) NOT NULL, AUTHOR_NAME VARCHAR(32) NOT NULL, MESSAGE VARCHAR(2000) NOT NULL)`);
